...
export default function Navbar() {
  ...
  return (
    <div>
      ...
      <div className="bg-black text-white border-b-2 h-24 hidden md:flex md:justify-evenly md:px-8 lg:px-12 xl:px-24 ">
        {/* Logo */}
        ...
        {/* Navbar links */}
        <div className="header-links contents font-semibold text-base lg:text-base " style={{position:"sticky",top:0}}>
        ...
        {/* <div className="header-links contents font-semibold text-base lg:text-base ">
          <ul className="flex items-center ml-4  lg:ml-5 xl:ml-2 lg:mr-8">
                ...
                <span
                  className={
                    selectedOption === "Solutions"
                      ? "text-[#14213d]"
                      : "hover:text-[#14213d] cursor-pointer"
                  }
                >
                  Solutions
                </span>
            ...
            <li className="p-2.5 xl:p-6">
              <button
                onMouseEnter={() => toggleIndustries("Industries")}
                className="focus:outline-none flex items-center"
              >
                <span
                  className={
                    selectedOption === "Industries"
                      ? "text-[#14213d]"
                      : "hover:text-[#14213d] cursor-pointer"
                  }
                >
            ...
            <li className="p-2.5 xl:p-6">
              <button
                onMouseEnter={() => toggleAIResources("AI Resources")}
                onClick={toggleAIResources}
                className="focus:outline-none flex items-center"
              >
                <span
                  className={
                    selectedOption === "AI resources"
                      ? "text-[#14213d]"
                      : "hover:text-[#14213d] cursor-pointer"
                  }
                >
        ...
        <div className=" md: lg:-ml-12 flex items-center gap-5 ">
          {/* <form action="" className="relative mx-auto w-max">
            ...
            <svg
              ...
              className="ml-0.5 absolute inset-y-0 my-auto h-8 w-12 border-r border-transparent stroke-gray-500 px-3.5 peer-focus:border-primary peer-focus:stroke-blue-500"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
              strokeWidth="2"
