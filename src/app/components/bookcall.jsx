...
export default function Book() {
  ...
  return (
    <div className="bg-[#14213D] md:ml-0 min-h-screen flex items-center justify-center px-2 mt-20">
      <div className="flex flex-col md:flex-row justify-between gap-4 w-full max-w-6xl p-2">
        {" "}
        {/* Adjusted max-width and added gap */}
        <div
          className="flex-1 mb-4 md:mb-0 p-6 rounded-lg shadow-lg"
          style={{
        ...
        <div
          className="justify-center items-center flex mt-8 w-full lg:w-1/2 sm:w-full md:justify-center md:w-full bg-white p-2 sm:p-6 rounded-lg shadow-lg"
