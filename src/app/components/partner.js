...
const PartnerCompanies = () => {
  ...
  return (
    <div className="bg-black pb-8 mt-10">
      <div className="container mx-auto px-6">
        <div className="flex flex-col items-center">
          <h2 className="text-xl text-white lg:text-2xl text-gray-600 pb-5 md:pb-0 whitespace-nowrap">Partnered with Innovators like</h2>
          <div className="flex justify-between items-center space-x-20 mt-4" width="100%">
