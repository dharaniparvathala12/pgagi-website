            ...
            <div className="w-full lg:w-6/12 px-4">
              <div className="flex items-center ">
                <Image
                  ...
                  alt="Company logo"
                  className="h-12 -ml-2 object-contain"
                  width={50}
                  height={50}
                />
              ...
              <div className="mb-6 flex items-center ">
                <a
                  ...
                  className="mr-3 flex h-10 w-10 items-center justify-center rounded-full border  text-dark border-primary bg-primary text-white mr-4 lg:mr-3 xl:mr-4"
                >
                  <img src="/images/TwitterX.png" />
                </a>
                <a
                  href="https://www.youtube.com/channel/UCKySzInhClSvewLucjmQmhQ"
                  className="mr-3 flex h-10 w-10 items-center justify-center rounded-full border  border-primary bg-primary text-white  sm:mr-4 lg:mr-3 xl:mr-4"
                >
                  <svg
                    width="16"
                    height="12"
                ...
                <a
                  href="https://twitter.com/PGAGI123"
                  className="mr-3 flex h-10 w-10 items-center justify-center rounded-full  border-primary bg-primary :text-white sm:mr-4 lg:mr-3 xl:mr-4"
                >
            ...
            <div className="w-full lg:w-6/12 px-4">
              <div className="flex flex-wrap items-top mb-6">
                <div className="w-full lg:w-4/12 px-4 ml-auto">
                  <span className="block uppercase text-blueGray-700 text-sm font-semibold mb-2 whitespace-nowrap">
                    Useful Links
                  </span>
                ...
                <div className="w-full lg:w-4/12 px-4 ">
                  <span className="block uppercase text-blueGray-500 text-sm font-semibold mb-2 hidden md:block">
                    Other Resources
                  </span>
        ...
        <div className="container mx-auto px-4 sm:hidden text-center">
          <div className="flex flex-col items-center">
            ...
            <div className="mb-6 flex justify-center items-center">
              <a
                href="https://twitter.com/PGAGI123"
                className="mr-3 flex h-10 w-10 items-center justify-center rounded-full border  hover:border-primary hover:bg-primary hover:text-white mr-4 lg:mr-3 xl:mr-4"
              >
                <svg
            ...
            h6l21.3-22.8L48,66h20L42.5,31.2z M12.9,10h8l38.1,52h-8L12.9,10z"
              ...
              <a
                href="https://www.youtube.com/channel/UCKySzInhClSvewLucjmQmhQ"
                className="mr-3 flex h-10 w-10 items-center justify-center rounded-full border  hover:border-primary hover:bg-primary hover:text-white  sm:mr-4 lg:mr-3 xl:mr-4"
              >
                <svg
                  width="16"
                  height="12"
              ...
              <a
                href="https://www.linkedin.com/company/pg-agi/"
                className="mr-3 flex h-10 w-10 items-center justify-center rounded-full border  text-dark hover:border-primary hover:bg-primary hover:text-white  sm:mr-4 lg:mr-3 xl:mr-4"
              >
                <svg
                  width="14"
                  height="14"
